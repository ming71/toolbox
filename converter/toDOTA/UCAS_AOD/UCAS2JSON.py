...
def generate_json_labels(src_path, out_path, trainval=True):
    ...
    with open(out_path, 'w') as f:
        ...
        for id, img in enumerate(pbar):
            pbar.set_description("UCAS-AOD generate_json_labels in {}".format(src_path))
            img_info = {}
...
if __name__ == '__main__':
    generate_json_labels('/data-input/RotationDet/data/GaoFen2020/airplane/train',
                         '/data-input/RotationDet/data/GaoFen2020/airplane/train/train.json')
    generate_json_labels('/data-input/RotationDet/data/GaoFen2020/airplane/val',
                         '/data-input/RotationDet/data/GaoFen2020/airplane/val/test.json', trainval=False)
    print('done!')
