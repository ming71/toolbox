...
def convert(src_path, img_path, dst_path, care_all=False, mode = 'ICDAR2015'):
         ...
         with open(os.path.join(src_path,icdar_file),'r',encoding='utf-8-sig') as fd:        #打开要读的文件
               ...
               for object in objects:
                  if mode == 'ICDAR2015' :
                     ...
                     xmin, ymin, xmax, ymax = [int(x) for x in object.split(' ')[:4]]
                     cx = (xmax + xmin) * 0.5
                     cy = (ymax + ymin) * 0.5
                     w  = xmax - xmin
                     h  = ymax - ymin
...
if __name__ == "__main__":
   ...
   src_path = "/py/datasets/ICDAR2015/ICDAR/ICDAR2013/train_label"
   img_path = '/py/datasets/ICDAR2015/ICDAR/ICDAR2013/train'
   dst_path = "/py/datasets/ICDAR2015/yolo/13+15/yolo_label"

   convert(src_path, img_path, dst_path, care_all, mode = 'ICDAR2013')
